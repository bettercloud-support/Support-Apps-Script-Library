var logSheet = SpreadsheetApp.openById("1MYWMDyGg1MbItcT4yYrYwgi2e3HKIhd085vgWib6New").getSheetByName("Log") //enter docID here

function myFunction() {
  var deletedUsers = AdminDirectory.Users.list({"customer": "my_customer", "showDeleted": true});
  var resource = {"orgUnitPath":"restored"}; //orgunit for restoration
