...
6) Select the 'lastEvent' function and press the Play button to run the script, Column B and C should populate with the last event for each Resource listed. http://screenshots.bettercloud.com/292A3H2n1U1q
